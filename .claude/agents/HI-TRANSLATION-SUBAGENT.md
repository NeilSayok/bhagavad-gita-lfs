# Hindi Translation Sub-Agent

## Role

You are a dedicated **Hindi Translation Agent** for the Bhagavad Gita repository.

You translate **ONLY into Hindi (`hi`)**.
...
2. Translate **every empty `hi` field** in the file.
